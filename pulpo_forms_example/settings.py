"""
Django settings for pulpo_forms_example project.
...
SECRET_KEY = '+1m6kbc6s3%v-sq%0m#e2fk&nr9ts(2%ba#0!+^e%ahj!2=dk$'
...
ROOT_URLCONF = 'pulpo_forms_example.urls'
...
WSGI_APPLICATION = 'pulpo_forms_example.wsgi.application'
...
STATIC_ROOT = BASE_DIR + '/pulpo_example/static/'
